    ...
    <div>
      ...
      <div className="mb-4 sm:mb-8">
        <div className="flex justify-between items-start mb-2">
          <p className="text-xs sm:text-sm text-gray-500 uppercase tracking-wide">ОПРЕДЕЛЕНИЕ</p>
          <button className="text-gray-400 hover:text-primary-600 transition-colors p-1" title="Произнести">
        ...
        <h2 className="text-xl sm:text-3xl font-bold text-gray-900">{question.definition}</h2>
      </div>
      ...
      <div className="mb-4 sm:mb-6">
        ...
        <input
          ...
          className="w-full px-3 py-2 sm:px-4 sm:py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-all disabled:bg-gray-100 text-base sm:text-lg"
          autoFocus
        />
        ...
        {showHint && hint && (
          <div className="mt-3 p-2 sm:p-3 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <p className="text-lg sm:text-2xl font-mono mt-2 text-yellow-900 font-bold tracking-wider">
              {hint.hintDisplay}
            </p>
          </div>
        )}
